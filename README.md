...
1. In 1-2 sentences, explain what React's `useRouteMatch` hook is used for.
   ...
   useRouteMatch is used to build relative route paths for code. this means that you can access the relative path and adjust it in your routing.

1. How would you explain form validation to someone who has never programmed before?

   Form validation is a way to check to make sure the data entered by a user is in the form you are expecting. Form validation will check for things like data type and ensure that everything is filled out that you want filled out.

1. In 1-2 sentences, define end to end testing.

   End to end testing is the process of replicating a users experience and making sure there are no bugs in the software. You do not want your user being the first test for bugs in a program, so you set up end to end testing to make sure that everything is functioning the way you intended it.
